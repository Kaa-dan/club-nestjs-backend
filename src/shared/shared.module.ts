...
import { ChapterRulesRegulations } from './entities/chapters/modules/chapter-rules-regulations.entity';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: ChapterRulesRegulations.name, schema: ChapterProjectSchema },
    ]),
